...
ggplot(data = gapminder, aes(x = lifeExp, fill = continent)) +
  geom_area(stat = "bin", position = "dodge", alpha = .5)
...
ggplot(data = gapminder, aes(x = lifeExp, fill = continent, color = continent)) +
  geom_density(stat = "bin", position = "dodge", alpha = .5)
...
ggplot(data = gapminder, aes(x = lifeExp, fill = continent, color = continent)) +
  geom_density(stat = "bin", position = "dodge", alpha = .2)
...
ggplot(
  data = gapminder,
  aes(x = continent, y = gdpPercap, color = continent, fill = continent)
  ) +
  scale_y_log10() +
  geom_violin()
